...
class TestReportLabelBarcodeGS1QR(TransactionCase):
    ...
    def _free_gtin14(cls):
        # Zero padded to 14 digits with a valid check digit, and unused: product
        # barcodes are unique.
    ...
    def test_receipt_lines_are_listed_whatever_the_product_carries(self):
        ...
        # The receipt destination is the location the shelves are keyed on.
    ...
    def test_sheet_starts_at_the_requested_cell(self):
        ...
        # 4 is the leftmost cell of the second row.
