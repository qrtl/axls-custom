...
class TestReportLabelBarcodeGS1QR(TransactionCase):
    ...
    def test_label_carries_purchase_analytic_and_location(self):
        ...
        self.assertIn(self.location.display_name, html)
    ...
    def test_receipt_lines_survive_the_missing_barcode_filter(self):
        ...
        self.assertEqual(wizard.product_print_moves.location_id, self.location)
