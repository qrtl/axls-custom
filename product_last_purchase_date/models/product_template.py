...
class ProductTemplate(models.Model):
    ...
    man_last_purchase_date = fields.Date(
        ...
        compute="_compute_man_last_purchase_date",
    ...
    def _compute_man_last_purchase_date(self):
    ...
    def _compute_last_purchase_date(self):
        ...
        for template in unique_variants:
            ...
            if man_last_purchase_date and (
                not last_purchase_date or man_last_purchase_date > last_purchase_date
            ):
