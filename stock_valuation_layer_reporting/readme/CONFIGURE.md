...
4. If none match, assign Other Category. If Other Category is not defined, the report
   category will remain empty. Records with an empty report category will not be displayed
   in the SVL report.
